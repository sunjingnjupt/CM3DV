...
import os
import warnings
from model import CM3DV, CM3DVMGDA, FeatEncoder
...
def eval_motion_displacement(model_path=None, save_eval_file_path=None, use_adj_frame_pred=False,
                             ...
                             height_feat_size=13, num_obj_category=5, which_model='CM3DV'):
    """
    ...
    if which_model == 'CM3DV':
        model = CM3DV(out_seq_len=20, motion_category_num=2, height_feat_size=height_feat_size)
        ...
        model_head = CM3DVMGDA(out_seq_len=20, motion_category_num=2)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-n', '--net', default='CM3DV', type=str, help='Which network [CM3DV/CM3DVMGDA]')
